...
export const ContextWindowProgress = ({ contextWindow, contextTokens, reservedTokens }: ContextWindowProgressProps) => {
	const { t } = useTranslation()

	// Use the shared utility function to calculate all token distribution values
	const tokenDistribution = useMemo(
		() => calculateTokenDistribution(contextWindow, contextTokens, reservedTokens),
		[contextWindow, contextTokens, reservedTokens],
	)

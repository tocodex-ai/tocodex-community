...
export const AutoApproveDropdown = ({ disabled = false, triggerClassName = "" }: AutoApproveDropdownProps) => {
	...
	const handleSelectAll = React.useCallback(() => {
		// Enable all options except followup questions (requires manual opt-in)
		Object.keys(autoApproveSettingsConfig).forEach((key) => {
			if (key !== "alwaysAllowFollowupQuestions") {
					...
					<div className="p-3 border-b border-vscode-dropdown-border">
						<div className="flex items-center justify-between gap-1 pr-1 pb-2">
							...
							<div className="flex items-center gap-1">
								<Settings
									className="inline mb-0.5 size-4 cursor-pointer"
									onClick={handleOpenSettings}
								/>
								<X
									className="inline mb-0.5 size-4 cursor-pointer text-vscode-descriptionForeground hover:text-vscode-foreground"

...
[頃滉淡鞏碷(../ko/CONTRIBUTING.md) 鈥?<b>Nederlands</b> 鈥?[Polski](../pl/CONTRIBUTING.md) 鈥?[Portugu锚s (BR)](../pt-BR/CONTRIBUTING.md) 鈥?[袪褍褋褋泻懈泄](../ru/CONTRIBUTING.md) 鈥?[T眉rk莽e](../tr/CONTRIBUTING.md) 鈥?[Ti岷縩g Vi峄噒](../vi/CONTRIBUTING.md) 鈥?[绠€浣撲腑鏂嘳(../zh-CN/CONTRIBUTING.md) 鈥?[绻侀珨涓枃](../zh-TW/CONTRIBUTING.md)
...
- Stroomlijn de UI/UX voor duidelijkheid en intu茂tiviteit.
...
- **Primair:** Word lid van onze [Discord](https://github.com/tocodex-ai/tocodex-community/issues) en stuur een DM naar **Hannes Rudolph (`hrudolph`)**.
- **Alternatief:** Ervaren bijdragers kunnen rechtstreeks deelnemen via [GitHub Projects](https://github.com/tocodex-ai/tocodex-community/issues).
...
- **Controleer bestaande issues**: Zoek in [GitHub Issues](https://github.com/tocodex-ai/tocodex-community/issues).
...
- **Wil je eraan werken?** Reageer met "Claiming" op de issue en stuur een DM naar **Hannes Rudolph (`hrudolph`)** op [Discord](https://github.com/tocodex-ai/tocodex-community/issues) om toegewezen te worden. De toewijzing wordt in de thread bevestigd.
- **PR's moeten naar de issue linken.** Niet-gekoppelde PR's kunnen worden gesloten.

### Beslissen waaraan je wilt werken

- Controleer het [GitHub Project](https://github.com/tocodex-ai/tocodex-community/issues) voor "Issue [Niet-toegewezen]" issues.
- Ga voor documentatie naar [Roo Code Docs](https://github.com/tocodex-ai/tocodex-community).

### Bugs rapporteren

- Controleer eerst bestaande rapporten.
- Maak een nieuwe bug aan met het ["Bugrapport"-sjabloon](https://github.com/tocodex-ai/tocodex-community/issues/new/choose) met:
...
- **Beveiligingsproblemen**: Rapporteer priv茅 via [beveiligingsadviezen](https://github.com/tocodex-ai/tocodex-community/security/advisories/new).
...
- E茅n gerichte PR per functie of fix.
...
- Rebase naar de nieuwste `main`-tak v贸贸r indiening.
...
- Moet verwijzen naar een toegewezen GitHub Issue. Om toegewezen te worden: reageer met "Claiming" op de issue en stuur een DM naar **Hannes Rudolph (`hrudolph`)** op [Discord](https://github.com/tocodex-ai/tocodex-community/issues). De toewijzing wordt in de thread bevestigd.

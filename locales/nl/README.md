...
<p align="center">
  <em>Snel hulp krijgen 鈫?<a href="https://github.com/tocodex-ai/tocodex-community/issues">Word lid van Discord</a> 鈥?Liever asynchroon? 鈫?<a href="https://github.com/tocodex-ai/tocodex-community/issues">Word lid van r/RooCode</a></em>
</p>
...
<details>
  <summary>馃寪 Beschikbare talen</summary>
...
Meer info: [Modi gebruiken](https://docs.roocode.com/basic-usage/using-modes) 鈥?[Aangepaste modi](https://docs.roocode.com/advanced-usage/custom-modes)
...
- **[Documentatie](https://docs.roocode.com):** De offici毛le gids voor het installeren, configureren en beheersen van Roo Code.
- **[YouTube-kanaal](https://youtube.com/@roocodeyt?feature=shared):** Bekijk tutorials en zie functies in actie.
- **[Discord Server](https://github.com/tocodex-ai/tocodex-community/issues):** Word lid van de community voor realtime hulp en discussie.
- **[Reddit Community](https://github.com/tocodex-ai/tocodex-community/issues):** Deel je ervaringen en kijk wat anderen bouwen.
- **[GitHub Issues](https://github.com/tocodex-ai/tocodex-community/issues):** Meld bugs en volg de ontwikkeling.
- **[Feature Requests](https://github.com/tocodex-ai/tocodex-community/issues/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Heb je een idee? Deel het met de ontwikkelaars.
...
Druk op `F5` (of ga naar **Uitvoeren** 鈫?**Foutopsporing starten**) in VSCode. Dit opent een nieuw VSCode-venster waarin de Roo Code-extensie wordt uitgevoerd.
...
**Veel plezier met Roo Code!** Of je het nu strak aan de lijn houdt of autonoom laat rondlopen, we zijn benieuwd wat je bouwt. Vragen of feature-idee毛n? Kom langs op onze [Reddit-community](https://github.com/tocodex-ai/tocodex-community/issues) of [Discord](https://github.com/tocodex-ai/tocodex-community/issues). Happy coding!

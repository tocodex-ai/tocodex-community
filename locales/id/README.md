...
<p align="center">
  <em>Dapatkan bantuan cepat 鈫?<a href="https://github.com/tocodex-ai/tocodex-community/issues">Gabung Discord</a> 鈥?Lebih suka asinkron? 鈫?<a href="https://github.com/tocodex-ai/tocodex-community/issues">Gabung r/RooCode</a></em>
</p>
...
<details>
  <summary>馃寪 Bahasa yang tersedia</summary>
...
Pelajari lebih lanjut: [Menggunakan Mode](https://docs.roocode.com/basic-usage/using-modes) 鈥?[Mode Kustom](https://docs.roocode.com/advanced-usage/custom-modes)
...
- **[Server Discord](https://github.com/tocodex-ai/tocodex-community/issues):** Bergabunglah dengan komunitas untuk bantuan dan diskusi real-time.
- **[Komunitas Reddit](https://github.com/tocodex-ai/tocodex-community/issues):** Bagikan pengalaman Anda dan lihat apa yang sedang dibangun orang lain.
- **[Masalah GitHub](https://github.com/tocodex-ai/tocodex-community/issues):** Laporkan bug dan lacak pengembangan.
- **[Permintaan Fitur](https://github.com/tocodex-ai/tocodex-community/issues/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Punya ide? Bagikan dengan para pengembang.
...
Tekan `F5` (atau buka **Run** 鈫?**Start Debugging**) di VSCode. Ini akan membuka jendela VSCode baru dengan ekstensi Roo Code berjalan.
...
**Selamat menikmati Roo Code!** Baik Anda mengendalikannya dengan ketat atau membiarkannya berkeliaran secara otonom, kami tidak sabar untuk melihat apa yang Anda bangun. Jika Anda memiliki pertanyaan atau ide fitur, kunjungi [komunitas Reddit](https://github.com/tocodex-ai/tocodex-community/issues) atau [Discord](https://github.com/tocodex-ai/tocodex-community/issues) kami. Selamat membuat kode!

 ...
 *
 * This writes logs to ~/.tocodex/cli-debug.log, avoiding stdout/stderr
...
const DEBUG_LOG_PATH = path.join(os.homedir(), ".tocodex", "cli-debug.log")
 ...
 * Writes timestamped entries to ~/.tocodex/cli-debug.log

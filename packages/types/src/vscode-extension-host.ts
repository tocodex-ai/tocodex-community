...
import type { GlobalSettings, RooCodeSettings } from "./global-settings.ts"
...
> & {
	...
	loadRecentPlans: boolean // Whether to load recent plans from .tocodex/plans/ into context
	...
	/** 当前任务的并行子任务状态快照（来自 Task.parallelChildren） */
	parallelChildren?: Array<{
		taskId: string
		description: string
...
export interface WebviewMessage {
	type:
		...
		| "rememberMemory"
		| "forgetMemory"
		// Global memory commands (/remember-global, /forget-global)
...
export interface ClineSayTool {
	...
	skill?: string
	// Properties for exitPlanMode tool
	result?: string
}

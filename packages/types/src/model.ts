import { z } from "zod"
import { DynamicProvider, LocalProvider } from "./provider-settings.ts"
...
export const modelInfoSchema = z.object({
	...
	// Model ratio from pricing API (e.g., 1.5 means 1.5x cost multiplier)
	...
	// 模型支持的 API 协议类型（如 ["anthropic", "openai"]）
	// 由 /v1/models 接口返回，用于自动选择最优协议

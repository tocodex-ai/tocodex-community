...
import { RooCodeEventName } from "./events.ts"
import type { RooCodeSettings } from "./global-settings.ts"
...
export interface CreateTaskOptions {
	...
	startTask?: boolean
	/**
	 * Mark this task as a background task (e.g., scheduled task).
	 * Background tasks do NOT remove the current user task from the stack,
	 * allowing them to run independently without interrupting user interaction.
	 */

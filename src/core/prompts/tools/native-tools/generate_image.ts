...
- size: (optional) The desired image size in "WIDTHxHEIGHT" format (e.g. "1024x1024", "1536x1024", "2048x2048", "4096x4096"). If not specified, the default size from user settings will be used.

Example: Generating a sunset image
{ "prompt": "A beautiful sunset over mountains with vibrant orange and purple colors", "path": "images/sunset.png", "image": null, "size": null }

Example: Generating a 4K wallpaper
{ "prompt": "A stunning galaxy with nebula clouds, 4K ultra high resolution", "path": "images/galaxy-4k.png", "image": null, "size": "4096x4096" }

Example: Editing an existing image
{ "prompt": "Transform this image into a watercolor painting style", "path": "images/watercolor-output.png", "image": "images/original-photo.jpg", "size": null }

Example: Upscaling and enhancing an image
{ "prompt": "Upscale this image to higher resolution, enhance details, improve clarity and sharpness while maintaining the original content and composition", "path": "images/enhanced-photo.png", "image": "images/low-res-photo.jpg", "size": "2048x2048" }`
...
const SIZE_PARAMETER_DESCRIPTION = `Optional image size in "WIDTHxHEIGHT" format (e.g. "1024x1024", "1536x1024", "2048x2048", "4096x4096"). If omitted, the default size from user settings is used.`
...
export default {
	...
	function: {
		...
		parameters: {
			...
			required: ["prompt", "path", "image", "size"],

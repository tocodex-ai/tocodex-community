...
<initialization>
  ...
  <todo_list_creation>
    ...
    1. Check for existing AGENTS.md files
       ...
       - .tocodex/rules-code/AGENTS.md (relative to project root)
       - .tocodex/rules-debug/AGENTS.md (relative to project root)
       - .tocodex/rules-ask/AGENTS.md (relative to project root)
       - .tocodex/rules-architect/AGENTS.md (relative to project root)
    ...
    8. Compile/Update AGENTS.md files
       ...
       - Create mode-specific files in .tocodex/rules-*/ directories (IN PROJECT ROOT)
...
<output_structure>
  ...
  <mode_specific_files>
    ...
    - .tocodex/rules-code/AGENTS.md (create .roo in project root, not system root!)
    - .tocodex/rules-debug/AGENTS.md (relative to project root)
    - .tocodex/rules-ask/AGENTS.md (relative to project root)
    - .tocodex/rules-architect/AGENTS.md (relative to project root)
    ...
    ├── .tocodex/                        # IN PROJECT ROOT, NOT SYSTEM ROOT!
    │   ├── rules-code/
    ...
    .tocodex/rules-code/AGENTS.md - ONLY non-obvious coding rules discovered by reading files:
    ...
    .tocodex/rules-debug/AGENTS.md - ONLY non-obvious debugging discoveries:
    ...
    .tocodex/rules-ask/AGENTS.md - ONLY non-obvious documentation context:
    ...
    .tocodex/rules-architect/AGENTS.md - ONLY non-obvious architectural constraints:

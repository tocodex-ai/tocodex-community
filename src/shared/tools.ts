...
export const toolParamNames = [
	...
	// lsp_code_intelligence parameters
	"operation",
	"filePath",
	"character",
	"symbol",
	...
	"maxLength",
	// spawn_parallel_task parameters
	"tasks",
	// notebook_edit parameters
	"cellIndex",
	"cellType",
] as const
...
export interface GenerateImageToolUse extends ToolUse<"generate_image"> {
	name: "generate_image"
	params: Partial<Pick<Record<ToolParamName, string>, "prompt" | "path" | "image" | "size">>
}
...
export const TOOL_DISPLAY_NAMES: Record<ToolName, string> = {
	...
	lsp_code_intelligence: "LSP code intelligence",
	web_fetch: "fetch web content",
	enter_plan_mode: "enter plan mode",
	exit_plan_mode: "exit plan mode",
	spawn_parallel_task: "spawn parallel tasks",
	tool_search: "search and load tools",
	notebook_edit: "edit notebook cells",
	schedule_task: "schedule tasks",
	list_scheduled_tasks: "list scheduled tasks",
	update_scheduled_task: "update scheduled tasks",
	cancel_scheduled_task: "cancel scheduled tasks",
	run_scheduled_task_now: "run scheduled tasks immediately",
	get_scheduled_task_runs: "get scheduled task run history",
} as const

// Define available tool groups.
export const TOOL_GROUPS: Record<ToolGroup, ToolGroupConfig> = {
	read: {
		tools: ["read_file", "search_files", "list_files", "codebase_search", "lsp_code_intelligence", "web_fetch"],
	},
	edit: {
		tools: ["apply_diff", "write_to_file", "generate_image", "notebook_edit"],
	...
	modes: {
		tools: ["switch_mode", "new_task", "spawn_parallel_task"],
...
export const ALWAYS_AVAILABLE_TOOLS: ToolName[] = [
	...
	"spawn_parallel_task",
	"tool_search",
	// Scheduled task tools - available in all modes for task automation management
	"schedule_task",
